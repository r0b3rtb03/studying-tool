...
- Text wrapped in **double asterisks** indicates the correct answer - extract the letter of that option as correctAnswer.
- Remove any ** markers from the option text in the output.`;
